    ...
    return (
        <div className="w-container mx-auto">
            ...
            <p className="my-10">
                ...
                osiągnięcia (jeśli takie masz) i oblicz punkty, jakie uzyskasz
                podczas rekrutacji do szkoły średniej.
            </p>
            <div
            ...
            >
                <p className="font-bold mb-2 flex items-center font-primary">
                    <TriangleAlertIcon className="mr-2 text-xl" />
                    Przypomnienie
                </p>
                <p>
                    Progi punktowe zmieniają się co roku i zależą od wielu
                    czynników.
                </p>
            </div>
            <Calculator />
