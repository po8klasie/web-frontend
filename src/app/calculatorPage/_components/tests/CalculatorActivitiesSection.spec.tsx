...
describe('_components/calculator/CalculatorActivitiesSection', () => {
    describe('CalculatorActivityCheckbox', () => {
        ...
        it('passes down input props', () => {
            ...
            expect(
                wrapper.getByTestId('input').getAttribute('maxLength')
            ).toEqual('2')
        })
        ...
        it('display calculatedPoints as integer', () => {
            const wrapper = render(
                <ActivityCheckbox
                    ...
                    calculatedPoints={20.2}
                />
            )
            expect(wrapper.getByTestId('calculated-points')).toHaveTextContent(
                '20'
            )
        })
    })
    ...
    describe('CalculatorActivitiesSection', () => {
        it('renders all checkboxes', () => {
            ...
            expect(wrapper.getByTestId('checkboxes').children.length).toEqual(
