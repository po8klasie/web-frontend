...
const ClassesForYearTable: FC<ClassesForYearTableProps> = ({
    classesForYear,
}) => {
    ...
    <details className="px-2 mt-2">
        ...
        <div className="px-4 mb-7">
            {classProfileDefaultDisplayConfig
                .filter(
                    (propertyConfig) =>
                        propertyConfig.isNotEmpty(classProfile) &&
                        propertyConfig.showOnMobile
                )
