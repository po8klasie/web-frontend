...
const FavoritesPage = () => {
  const {favoriteInstitutionsRspos, toggleIsInstitutionFavorite, isInstitutionFavorite} = useFavoriteInstitutions()

  const queryString = useMemo(() => stringify({rspo: favoriteInstitutionsRspos}),  [favoriteInstitutionsRspos])
          ...
          !isFetching && parsedData.length === 0 && (
            <div className="">
              ...
              <p className="text-gray-700 text-center mt-2">
                Klikając <FiStar className="inline stroke-current text-primary" />{' '}
