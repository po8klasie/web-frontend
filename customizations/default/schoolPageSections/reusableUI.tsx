...
interface DataPresentGuardProps<T extends unknown | null> {
    data: T
    NAClassName?: string
    render: (data: NonNullable<T>) => Element
}

export const DataPresentGuard = <T,>({
    data,
    NAClassName,
    render,
}: DataPresentGuardProps<T>) => {
...
export const SimpleUnorderedList: FC<SimpleUnorderedListProps> = ({
    items,
}) => (
...
const ItemWithIcon: FC<ItemWithIconProps> = ({
    children,
    icon: Icon,
    iconClassName,
}) => (
