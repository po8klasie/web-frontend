...
import {
    isExamResultValid,
    isGradeValid,
} from '@warsawlo/points-calculator/lib/utils/validators'
...
export const GradeInput: FC<CalculatorInputProps> = ({ inputId, ...props }) => {
    ...
    const setValue = (updatedValue: number | null) =>
        setValueOriginal(inputId, updatedValue)
...
export const ExamResultInput: FC<CalculatorInputProps> = ({
    inputId,
    ...props
}) => {
    const { watch, setValue: setValueOriginal, setError } = useFormContext()
