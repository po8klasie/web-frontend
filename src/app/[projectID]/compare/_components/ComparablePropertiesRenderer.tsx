...
const ComparablePropertiesRenderer: FC<ComparablePropertiesProps> = ({
  comparisonItems,
  propertiesMaxLengths,
}) => {
  return (
    <div>
      {comparableProperties.map(
        ({ sectionName, renderComparisonListContents, getBlankItemsNo }) => (
          <div className="" key={sectionName}>
            ...
            <ComparisonList>
              ...
              {getBlankItemsNo && (
                <ComparisonListBlank
                  blankItemsNo={getBlankItemsNo(comparisonItems, propertiesMaxLengths)}
                />
              )}
            </ComparisonList>
          </div>
